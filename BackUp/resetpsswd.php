...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
 ...
 <div class="some" >
	...
	<div class="container">
        <div id="form_wrapper">
            <div id="form_left">
                <img src="data/logo.png"  width="50" height="70" alt="GOVERNMENT COLLEGE OF ENGINEERING AND CERAMIC TECHNOLOGY">
            </div>
			<form method="post" action="pssw.php">
            <div id="form_right">
                <h1>Reset Password</h1>
				<b>Note:</b>Password after reset will be "12345678"
                <div class="input_container">
                    <input placeholder="ENTER  ROLL NUMBER" type="text" name="password" id="field_email" class=\'input_field\'>
                </div>
                <input type="submit" value="RESET" id=\'input_submit\' class=\'input_field\'>
			</div>
			</form>
        </div>
		</div>
