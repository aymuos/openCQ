...
<body>
  ...
  <a class="navbar-brand text-wrap font-weight-bold" href="#"><h2>Subject Choice </h2></a>
  ...
  <form class="form-inline my-2 my-lg-0 ml-auto">
    <button class="btn btn-lg align-right elegant-color-dark white-text font-weight-bolder " type="button"><i class="fas fa-lg mr-3 fa-sign-out-alt"></i>LOGOUT</button>
  </form>
...
<div class="select-box">
	<div  id="selector" class="top-box">
		<div class="md-form input-group mb-3 tokyo">
			<input id="inp" type="text" class="form-control" placeholder="Click to add a subject" readonly>
