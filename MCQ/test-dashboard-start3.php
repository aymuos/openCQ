...
//This page simply display that the test has been started successfully.
...
<body id="page7">
	...
	<div class="well-lg">
		<div class="alert alert-success">
			<p class="text-center">Test Successfully <strong>Started</strong>!</p>
		</div>
	</div>
	
	<div class="container">
	<div class="button-container">
		<button class="btn btn-success" onclick="location.href=\'test-dashboard.php\'">Ok</button>
	</div>
	</div>
