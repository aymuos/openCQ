...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
  <link rel="stylesheet" href="coe_outputtable.css" >
  ...
  <script type="text/javascript">
	...
	$(document).ready(function () {	
		...
		var td=tableData[0];
		window.location.href = "coe_view_result4.php?st_id=" + td + "&test_id=';echo $test_id;echo '";
...
<p><h1 class="crjk">
  ...
  <p class="clkk" style="text-align: center">(Click on the row to view the Answer script)</p>
	...
	<div class="button-container" style="text-align:center;">
		...
		<button type="button" class="btn btn-danger" onclick="location.href=\'coe_exams_past.php\'">Cancel</button>
	</div>
