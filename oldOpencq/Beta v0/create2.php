...
try{
	...
	$query = "INSERT INTO student(user_id, password, name, department, year, email, registration) VALUES (?,?,?,?,?,?,?)";
	execute($conn,$query,"ssssssi",[$roll,$psw,$name,$dept,$year,$email,$reg],$stmt);
