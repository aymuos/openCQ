    ...
    <!--card-->
            <div class="card-content">
                <span class="card-title  black-text text-darken-4"></span>
                      <p><h3><blockquote>QUESTION BANK SECTION</blockquote></h3></p>
                      <h6 style="font-style: italic;"> Click button to add , modify or delete chapters or questions </h6>
                      <div class="gibpadding2">
                        <a href= "tselectchapter.php" class="waves-effect waves-light btn-large right deep-purple darken-4"><i class="material-icons right">trending_flat</i>GO</a>
                      </div>
            </div>
...
<!--card 2-->
            ...
            <div class="card-content">
                <span class="card-title activator black-text text-darken-4">Click to access more 
                    <i class="material-icons right">menu_open</i></span>
                      <p><h3><blockquote>EXAMINATION SECTION</blockquote></h3></p>
    ...
    -->
      ...
      <div class="row cardpad">
        <div class ="col s8 offset-s2 ">
            <div class="card small black-text z-depth-5">
              <div class="card-content">
                  <p><h3><blockquote>LOGIN PASSWORD REST</blockquote></h3></p>
                  <P><h6 style="font-style: italic;"> Click the button to reset your password</h6></p>
                   <a class="btn-floating btn-large waves-effect waves-light red right"><p class="thick">GO</p></a>
              </div>
            </div>
        </div>
      </div>
    ...
    <div class="card white">
      <div class="card-content">
        <span class="black-text">Need to change subject ? Click the following button
        </span>
         <a class="btn-floating btn-large waves-effect waves-light orange right" href="tdbselectsubjectv1.php"><i class="material-icons">fingerprint</i></a>
      </div>
      </div>
    </div>
  </div>    
