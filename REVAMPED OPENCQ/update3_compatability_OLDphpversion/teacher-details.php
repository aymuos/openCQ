...
<body>
    ...
    <div class="nav-wrapper light-blue darken-4 col s12">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
		<li><a class="waves-effect waves-light black white-text btn" href="change-teacher-password.php">Change Password</a></li>
        <li><a class="waves-effect waves-light black white-text btn" href="';
  ...
  <!--navigation bar ends-->
  <div id="centering cardpadmini">
  <div class="row">
    <div class="col s10 offset-s1 ">
      <div class="card wide white z-depth-5">
        <div class="card-content  indigo-text">
          <span class="card-title center"><h4>Faculty Details</h4></span>
