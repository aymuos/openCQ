...
<body style = "font-family: Segoe UI, Tahoma, Geneva, Verdana, sans-serif; background-image: linear-gradient(rgb(163, 239, 241), rgb(247, 247, 222), rgb(185, 238, 124))">
    <nav>
    <div class="row">
    <div class="nav-wrapper light-blue accent-2 col s12">
    <label class="brand-logo center"><a href ="#!">Change Password - Faculty Userspace</a><i class="material-icons">face</i></label>
    
      <ul id="nav-mobile" class="right ">
		<li><a role="button" class="btn waves-effect waves-light z-depth-3 deep-purple darken-4" href="teacher-details.php">Account</a></li>
        <li><a role="button" class="btn waves-effect waves-light grey darken-4 z-depth-3" href="';
