				...
				<div class="col s12">
					<div class="card deep-purple darken-4 z-depth-5">
						<div class="card-content lime-text darken-4">
							...
							<!-- inside the Card-->
							<a class="waves-effect brown darken-1   waves-light btn" href="coe_exams_present.php" style="margin-right:20px"><i class="material-icons left">assessment</i>RUNNING EXAMS</a>
								<!-- <a class="col s1"> </a> -->
							<a class="waves-effect green darken-1  waves-light btn" href="coe_exams_past.php" style="margin-right: 20px"><i class="material-icons left">history</i>Past Exams</a>
								<!-- <a class="col s1"> </a> -->
							<a class="btn waves-effect blue darken-2 waves-light " href="coe_exams_future.php" style="margin-right: 20px">
								<i class="material-icons left">timeline</i>AVAILABLE EXAMS</a>
							
								<!-- <a class="col s1"> </a> -->
							<a class="btn waves-effect orange darken-4 waves-light " onclick="generate()" >
				...
				<div class="col s12 ">
					<div class="card deep-purple darken-4 z-depth-5">
						<div class="card-content amber-text darken-4">
							...
							<!-- inside the Card-->
							<a class="waves-effect red darken-4  waves-light btn" href="coe_view_students.php" style="margin-right: 30px">
								<i class="material-icons left">people</i>Students</a>
								
							<a class="col s1"> </a>
							<a class="waves-effect blue-grey z-depth-4 waves-light btn" href="coe_availablesubcodes.php"style="margin-right: 30px">
								<i class="material-icons left" >explore</i>Subject codes</a>
							<a class="col s1"> </a>
							<a class="waves-effect blue darken-4 waves-light btn" href="coe_view_teachers.php" style="margin-right: 30px"><i class="material-icons left">person</i>Faculty</a>
						</div>
					</div>
				</div>
			</div>
