    ...
    cat={};
        ...
        fetch(
          ...
          (e)=>{
            ...
            location.href = \'tdberrormessage.html\';;
          } 
...
<body style = "font-family: Segoe UI, Tahoma, Geneva, Verdana, sans-serif; background-image: linear-gradient(rgb(248, 174, 131), rgb(247, 247, 222), #f5f5f5)">
    <nav>
    <div class="row">
    <div class="nav-wrapper orange darken-1 col s12">
    <label class="brand-logo center"><a href ="#!">Change Password - Student Userspace</a><i class="material-icons">portrait</i></label>
    
      <ul id="nav-mobile" class="right ">
		<li><a role="button" class="btn waves-effect waves-light z-depth-3 deep-purple darken-4" href="student-details.php">Account</a></li>
        <li><a role="button" class="btn waves-effect waves-light grey darken-4 z-depth-3" href="student_dashboard.php">DASHBOARD</a></li>
