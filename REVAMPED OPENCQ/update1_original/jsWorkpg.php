    ...
    <div class="card-tabs">
      <ul class="tabs tabs-fixed-width">';
		...
		for($i=1;$i<=$len;$i++){
			...
			if($questions->result[$i-1]->{'marked option'} != 0)echo 'style="background-color: hsla(162, 75%, 52%, 0.575)"';
			else if($i==1)
			...
			if($questions->result[$i-1]->{'marked option'} != 0)echo 'style="color: #666666;"';
		...
		echo '<div id="test'.$i.'">
			...
			<div class="total" id="q'.$i.'o1">
				<div class="custom-left">
					...
					if($questions->result[$i-1]->{'marked option'} == '1')echo 'checked="true"';
			...
			<div class="total" id="q'.$i.'o2">
				<div class="custom-left">
					...
					if($questions->result[$i-1]->{'marked option'} == '2')echo 'checked="true"';
			...
			<div class="total" id="q'.$i.'o3">
				<div class="custom-left">
					...
					if($questions->result[$i-1]->{'marked option'} == '3')echo 'checked="true"';
			...
			<div class="total" id="q'.$i.'o4">
				<div class="custom-left">
					...
					if($questions->result[$i-1]->{'marked option'} == '4')echo 'checked="true"';
