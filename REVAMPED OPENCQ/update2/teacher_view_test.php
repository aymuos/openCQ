...
<!DOCTYPE html>
  ...
  <nav>
    <div class="nav-wrapper gradient1">
      ...
      <a class="brand-logo" href="tdbhomeV2.php"><h5>   Teacher Userspace - Question Paper </h5></a>
  ...
  <nav class="heightadjustnav2 z-depth-5">
    <div class="nav-wrapper gradient3">
      ...
      <a href="teacher-login.html" class="breadcrumb">Login</a>
        ...
        <a href="" class="breadcrumb">Question Paper</a>
      </div>
    </div>
  </nav>
...
<div class="container" style="text-align: center;margin-top: 100px;">
	...
	<button class="btn red s2 col" onclick="location.href='teacher_view_past_exam.php'">Back</button>
