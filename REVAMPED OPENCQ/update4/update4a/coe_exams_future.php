...
(function ($) {
	...
	function view_test(ti){
		window.open("coe_preview_question_paper.php?e=" + ti, \'_blank\');
	}
</script>
	</head>
	<body>
    ...
    <label class="brand-logo center"><a href ="coe_dashboard.php"> AVAILABLE EXAMS - COE USERSPACE </a><i class="material-icons">portrait</i></label>
    ...
    <div class="container z-depth-5 grey-blue darken-4" style="background-color:black;">
