...
<div class="col s1" style="text-align: center;margin-top: 60px;">
    <a class="waves-effect waves-light btn btn-large red" onclick="location.href='view_result_coe.php?e=<?php echo $_SESSION['viewExamId'] ?>'"><i class="material-icons left"></i>Back</a>
</div>
