...
<script>
    ...
    <label class="brand-logo center"><a href ="coe_dashboard.php"> PAST EXAMS - COE USERSPACE </a><i class="material-icons">portrait</i></label>
...
//		echo $len;
		...
		echo '
          <tr>
            ...
            <td><a class="btn-floating btn-small waves-effect pulse waves-light blue" target="_blank" href=\'coe_preview_question_paper.php?e=';
			...
			<td>
			<a class="btn-floating btn-small waves-effect pulse waves-light green" target="_blank" href="view_result_coe.php?e=';
