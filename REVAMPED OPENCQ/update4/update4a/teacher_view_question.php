  ...
  <nav class="heightadjustnav2 z-depth-5">
    ...
    <div class="col s10 offset-s1">
      <div class="card leeftpad white z-depth-4">
        ...
        <div class="col s4">
        <p class= "leftpad" ><b> Chapter Name: </b><?php echo $chaptername ?></p> <!--JS bring username from api-->
        </div>
	...
	<li>
		...
		<div class="collapsible-body white">
			<div class="row">
				...
				<div class="col"><a class="btn blue btn-waves-effect" onclick="modify('.($ans->result[$i]->id).')">Modify</a>
				</div>
...
<div class="container" style="text-align: center;margin-top: 100px;">
    ...
    function modify(id){
      location.href=`teacher_modify_question.php?id=${id}`;
    }
		function myFunc(){
			location.reload();
		}
