	...
	<script>
		function addData() {
			...
			if(username == "" ){
				...
				xhttp.send("uname=" + encodeURIComponent(username) + "&psw=" + encodeURIComponent(password));
				}
			}
	</script>
...
<body>
    ...
    <div class="nav-wrapper light-blue darken-4 col s12">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        <li><a href="coe_dashboard.php">Back to previous page </a></li>
    ...
    <div class="col s12 centered">
      <div class="card large white darken-1 z-depth-5">
        <div class="card-content black-text">
          <span class="card-title center "><h1>Add/Update Faculty Details</h1></span>
      ...
      <!--password field-->
            ...
            <div class="card-action center">
                    ...
                    <a onclick="addData()" class="waves-effect waves-light green darken-3 btn">
						<i class="material-icons right">save</i>SAVE AND CONTINUE</a>
            </div>
        </div>
    </div>
    </div
