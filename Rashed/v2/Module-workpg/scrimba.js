...
function color_tab(id){
	...
	if(document.getElementById("tab"+id).style.backgroundColor != "rgb(0, 179, 0)"){
...
function save_color_tab(id){
	document.getElementById("tab"+id).style.backgroundColor = "#00b300";
	document.getElementById("htab"+id).style.color = "#ffffff";
}
