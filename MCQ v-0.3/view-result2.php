...
<html>
	...
	<body>
		...
		<div class="normal">
		<form action="view-result3.php" method="post"> <!--add action="php filename-->
			<fieldset>
			...
			echo date('d/m/Y',$exam[0]['start_time']);
			...
			<br><br>
			<div class="disv" >
				<button type="button" class="btn btn-danger" onclick="location.href=\'view-result.php\'">Change Test</button> 
